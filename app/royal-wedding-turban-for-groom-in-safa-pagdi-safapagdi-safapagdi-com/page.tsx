...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: "https://safapagdi.com/royal-wedding-turban-for-groom-in-safa-pagdi",
    type: "website",
  },
}
...
export default function RoyalWeddingTurbanForGroomInIndiaPage() {
  const pageData = {
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["On-site professional service at your India venue", "Complete barati packages with matching coordination", "Customized designs matching your wedding theme and outfit", "Expert turban specialists with 40+ years experience in India", "Perfect fit with maximum comfort guaranteed all day", "Free consultation and design preview via WhatsApp"],
