...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: "https://safapagdi.com/indian-dulha-turban-in-safa-pagdi",
    type: "website",
  },
}
...
export default function IndianDulhaTurbanInIndiaPage() {
  const pageData = {
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["Perfect fit with maximum comfort guaranteed all day", "Premium materials - silk, brocade, velvet, and designer fabrics", "Authentic traditional tying techniques perfected over generations", "Competitive pricing for individual and bulk orders", "Free consultation and design preview via WhatsApp", "Complete barati packages with matching coordination"],
