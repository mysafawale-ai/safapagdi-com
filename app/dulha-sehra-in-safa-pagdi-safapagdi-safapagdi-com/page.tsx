...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: "https://safapagdi.com/dulha-sehra-in-safa-pagdi",
    type: "website",
  },
}
...
export default function DulhaSehraInIndiaPage() {
  const pageData = {
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["Perfect fit with maximum comfort guaranteed all day", "Expert sehra specialists with 40+ years experience in India", "Emergency last-minute service available in India", "Customized designs matching your wedding theme and outfit", "Free consultation and design preview via WhatsApp", "Complete barati packages with matching coordination"],
