...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: "https://safapagdi.com/safa-garments-in-safa-pagdi",
    type: "website",
  },
}
...
export default function SafaGarmentsInIndiaPage() {
  const pageData = {
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["On-site professional service at your India venue", "Customized designs matching your wedding theme and outfit", "Perfect fit with maximum comfort guaranteed all day", "Emergency last-minute service available in India", "Authentic traditional tying techniques perfected over generations", "Premium materials - silk, brocade, velvet, and designer fabrics"],
