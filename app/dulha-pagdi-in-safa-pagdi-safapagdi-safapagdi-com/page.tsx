...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: "https://safapagdi.com/dulha-pagdi-in-safa-pagdi",
    type: "website",
  },
}
...
export default function DulhaPagdiInIndiaPage() {
  const pageData = {
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["Emergency last-minute service available in India", "Perfect fit with maximum comfort guaranteed all day", "Competitive pricing for individual and bulk orders", "Premium materials - silk, brocade, velvet, and designer fabrics", "Free consultation and design preview via WhatsApp", "Customized designs matching your wedding theme and outfit"],
