...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: "https://safapagdi.com/pagdi-bandhne-wala-in-safa-pagdi",
    type: "website",
  },
}
...
export default function PagdiBandhneWalaInIndiaPage() {
  const pageData = {
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["Premium materials - silk, brocade, velvet, and designer fabrics", "Emergency last-minute service available in India", "On-site professional service at your India venue", "Expert pagdi specialists with 40+ years experience in India", "Customized designs matching your wedding theme and outfit", "Complete barati packages with matching coordination"],
