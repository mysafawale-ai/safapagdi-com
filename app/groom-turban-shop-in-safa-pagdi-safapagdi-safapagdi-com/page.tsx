...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: "https://safapagdi.com/groom-turban-shop-in-safa-pagdi",
    type: "website",
  },
}
...
export default function GroomTurbanShopInIndiaPage() {
  const pageData = {
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["On-site professional service at your India venue", "Perfect fit with maximum comfort guaranteed all day", "Competitive pricing for individual and bulk orders", "Emergency last-minute service available in India", "Expert turban specialists with 40+ years experience in India", "Free consultation and design preview via WhatsApp"],
