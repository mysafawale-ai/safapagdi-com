...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: "https://safapagdi.com/sehra-for-groom-in-safa-pagdi",
    type: "website",
  },
}
...
export default function SehraForGroomInIndiaPage() {
  const pageData = {
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["Competitive pricing for individual and bulk orders", "Authentic traditional tying techniques perfected over generations", "On-site professional service at your India venue", "Perfect fit with maximum comfort guaranteed all day", "Expert sehra specialists with 40+ years experience in India", "Emergency last-minute service available in India"],
