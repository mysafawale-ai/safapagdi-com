...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: "https://safapagdi.com/jodhpuri-safa-design-in-safa-pagdi",
    type: "website",
  },
}
...
export default function JodhpuriSafaDesignInIndiaPage() {
  const pageData = {
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["Complete barati packages with matching coordination", "Perfect fit with maximum comfort guaranteed all day", "Customized designs matching your wedding theme and outfit", "Competitive pricing for individual and bulk orders", "Emergency last-minute service available in India", "Expert safa specialists with 40+ years experience in India"],
