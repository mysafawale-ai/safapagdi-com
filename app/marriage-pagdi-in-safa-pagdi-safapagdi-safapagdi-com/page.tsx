...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: "https://safapagdi.com/marriage-pagdi-in-safa-pagdi",
    type: "website",
  },
}
...
export default function MarriagePagdiInIndiaPage() {
  const pageData = {
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["Customized designs matching your wedding theme and outfit", "Perfect fit with maximum comfort guaranteed all day", "Premium materials - silk, brocade, velvet, and designer fabrics", "Emergency last-minute service available in India", "Free consultation and design preview via WhatsApp", "Complete barati packages with matching coordination"],
