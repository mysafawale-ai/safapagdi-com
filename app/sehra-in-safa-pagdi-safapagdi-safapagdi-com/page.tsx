...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: "https://safapagdi.com/sehra-in-safa-pagdi",
    type: "website",
  },
}
...
export default function SehraInIndiaPage() {
  const pageData = {
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["Emergency last-minute service available in India", "Complete barati packages with matching coordination", "Free consultation and design preview via WhatsApp", "Expert sehra specialists with 40+ years experience in India", "On-site professional service at your India venue", "Competitive pricing for individual and bulk orders"],
