...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: "https://safapagdi.com/heritage-feta-turban-hire-in-safa-pagdi",
    type: "website",
  },
}
...
export default function HeritageFetaTurbanHireInIndiaPage() {
  const pageData = {
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["Free consultation and design preview via WhatsApp", "Perfect fit with maximum comfort guaranteed all day", "On-site professional service at your India venue", "Competitive pricing for individual and bulk orders", "Customized designs matching your wedding theme and outfit", "Complete barati packages with matching coordination"],
