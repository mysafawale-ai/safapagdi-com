...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: "https://safapagdi.com/dulhe-ka-sehra-in-safa-pagdi",
    type: "website",
  },
}
...
export default function DulheKaSehraInIndiaPage() {
  const pageData = {
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["Complete barati packages with matching coordination", "On-site professional service at your India venue", "Authentic traditional tying techniques perfected over generations", "Competitive pricing for individual and bulk orders", "Expert sehra specialists with 40+ years experience in India", "Free consultation and design preview via WhatsApp"],
