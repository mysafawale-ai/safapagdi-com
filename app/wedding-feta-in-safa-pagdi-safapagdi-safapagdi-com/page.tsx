...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: "https://safapagdi.com/wedding-feta-in-safa-pagdi",
    type: "website",
  },
}
...
export default function WeddingFetaInIndiaPage() {
  const pageData = {
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["On-site professional service at your India venue", "Customized designs matching your wedding theme and outfit", "Premium materials - silk, brocade, velvet, and designer fabrics", "Emergency last-minute service available in India", "Expert feta specialists with 40+ years experience in India", "Perfect fit with maximum comfort guaranteed all day"],
...
<p>Safawala India presents the most exquisite Feta collection in the region. Our master craftsmen specialize in creating the perfect turban experience for traditional ceremonies.</p>
