...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: "https://safapagdi.com/wedding-turban-draping-in-safa-pagdi",
    type: "website",
  },
}
...
export default function WeddingTurbanDrapingInIndiaPage() {
  const pageData = {
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["Competitive pricing for individual and bulk orders", "Perfect fit with maximum comfort guaranteed all day", "On-site professional service at your India venue", "Authentic traditional tying techniques perfected over generations", "Emergency last-minute service available in India", "Premium materials - silk, brocade, velvet, and designer fabrics"],
