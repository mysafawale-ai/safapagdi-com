...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: "https://safapagdi.com/feta-for-groom-in-safa-pagdi",
    type: "website",
  },
}
...
export default function FetaForGroomInIndiaPage() {
  const pageData = {
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["On-site professional service at your India venue", "Free consultation and design preview via WhatsApp", "Complete barati packages with matching coordination", "Emergency last-minute service available in India", "Expert feta specialists with 40+ years experience in India", "Premium materials - silk, brocade, velvet, and designer fabrics"],
