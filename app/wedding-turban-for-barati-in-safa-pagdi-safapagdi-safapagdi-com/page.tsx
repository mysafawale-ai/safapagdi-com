...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: "https://safapagdi.com/wedding-turban-for-barati-in-safa-pagdi",
    type: "website",
  },
}
...
export default function WeddingTurbanForBaratiInIndiaPage() {
  const pageData = {
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["Free consultation and design preview via WhatsApp", "Emergency last-minute service available in India", "Perfect fit with maximum comfort guaranteed all day", "Expert turban specialists with 40+ years experience in India", "Premium materials - silk, brocade, velvet, and designer fabrics", "Competitive pricing for individual and bulk orders"],
