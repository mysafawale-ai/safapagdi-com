...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: "https://safapagdi.com/safa-pagdi-in-safa-pagdi",
    type: "website",
  },
}
...
export default function SafaPagdiInIndiaPage() {
  const pageData = {
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["Premium materials - silk, brocade, velvet, and designer fabrics", "Free consultation and design preview via WhatsApp", "Customized designs matching your wedding theme and outfit", "Competitive pricing for individual and bulk orders", "Emergency last-minute service available in India", "Expert pagdi specialists with 40+ years experience in India"],
