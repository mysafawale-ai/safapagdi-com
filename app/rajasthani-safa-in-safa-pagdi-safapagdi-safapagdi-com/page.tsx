...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: "https://safapagdi.com/rajasthani-safa-in-safa-pagdi",
    type: "website",
  },
}
...
export default function RajasthaniSafaInIndiaPage() {
  const pageData = {
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["On-site professional service at your India venue", "Expert safa specialists with 40+ years experience in India", "Perfect fit with maximum comfort guaranteed all day", "Customized designs matching your wedding theme and outfit", "Authentic traditional tying techniques perfected over generations", "Competitive pricing for individual and bulk orders"],
