...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: "https://safapagdi.com/safa-for-groom-in-safa-pagdi",
    type: "website",
  },
}
...
export default function SafaForGroomInIndiaPage() {
  const pageData = {
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["Expert safa specialists with 40+ years experience in India", "Authentic traditional tying techniques perfected over generations", "Emergency last-minute service available in India", "Perfect fit with maximum comfort guaranteed all day", "Customized designs matching your wedding theme and outfit", "Complete barati packages with matching coordination"],
