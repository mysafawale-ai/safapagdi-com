...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: "https://safapagdi.com/wedding-pagri-in-safa-pagdi",
    type: "website",
  },
}
...
export default function WeddingPagriInIndiaPage() {
  const pageData = {
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["Emergency last-minute service available in India", "Customized designs matching your wedding theme and outfit", "Free consultation and design preview via WhatsApp", "Competitive pricing for individual and bulk orders", "Premium materials - silk, brocade, velvet, and designer fabrics", "On-site professional service at your India venue"],
