...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: "https://safapagdi.com/designer-wedding-turban-in-safa-pagdi",
    type: "website",
  },
}
...
export default function DesignerWeddingTurbanInIndiaPage() {
  const pageData = {
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["Free consultation and design preview via WhatsApp", "Expert turban specialists with 40+ years experience in India", "Premium materials - silk, brocade, velvet, and designer fabrics", "Competitive pricing for individual and bulk orders", "Emergency last-minute service available in India", "On-site professional service at your India venue"],
