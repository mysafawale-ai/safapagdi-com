...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: "https://safapagdi.com/luxury-wedding-turban-in-safa-pagdi",
    type: "website",
  },
}
...
export default function LuxuryWeddingTurbanInIndiaPage() {
  const pageData = {
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["Free consultation and design preview via WhatsApp", "Competitive pricing for individual and bulk orders", "Authentic traditional tying techniques perfected over generations", "Perfect fit with maximum comfort guaranteed all day", "Emergency last-minute service available in India", "On-site professional service at your India venue"],
