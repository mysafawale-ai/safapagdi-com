...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: "https://safapagdi.com/rajputi-safa-in-safa-pagdi",
    type: "website",
  },
}
...
export default function RajputiSafaInIndiaPage() {
  const pageData = {
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["On-site professional service at your India venue", "Customized designs matching your wedding theme and outfit", "Authentic traditional tying techniques perfected over generations", "Competitive pricing for individual and bulk orders", "Emergency last-minute service available in India", "Free consultation and design preview via WhatsApp"],
