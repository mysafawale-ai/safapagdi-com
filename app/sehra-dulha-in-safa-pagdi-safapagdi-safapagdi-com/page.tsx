...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: "https://safapagdi.com/sehra-dulha-in-safa-pagdi",
    type: "website",
  },
}
...
export default function SehraDulhaInIndiaPage() {
  const pageData = {
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["Competitive pricing for individual and bulk orders", "Perfect fit with maximum comfort guaranteed all day", "Complete barati packages with matching coordination", "On-site professional service at your India venue", "Premium materials - silk, brocade, velvet, and designer fabrics", "Authentic traditional tying techniques perfected over generations"],
