...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: "https://safapagdi.com/groom-sehra-in-safa-pagdi",
    type: "website",
  },
}
...
export default function GroomSehraInIndiaPage() {
  const pageData = {
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["Free consultation and design preview via WhatsApp", "Complete barati packages with matching coordination", "Premium materials - silk, brocade, velvet, and designer fabrics", "Expert sehra specialists with 40+ years experience in India", "Customized designs matching your wedding theme and outfit", "Competitive pricing for individual and bulk orders"],
