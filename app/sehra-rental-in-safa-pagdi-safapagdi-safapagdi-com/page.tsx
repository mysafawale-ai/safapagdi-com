...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: "https://safapagdi.com/sehra-rental-in-safa-pagdi",
    type: "website",
  },
}
...
export default function SehraRentalInIndiaPage() {
  const pageData = {
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["Premium materials - silk, brocade, velvet, and designer fabrics", "Free consultation and design preview via WhatsApp", "Customized designs matching your wedding theme and outfit", "On-site professional service at your India venue", "Authentic traditional tying techniques perfected over generations", "Emergency last-minute service available in India"],
