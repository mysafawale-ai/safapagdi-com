...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: "https://safapagdi.com/royal-wedding-safa-in-safa-pagdi",
    type: "website",
  },
}
...
export default function RoyalWeddingSafaInIndiaPage() {
  const pageData = {
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["Authentic traditional tying techniques perfected over generations", "Expert safa specialists with 40+ years experience in India", "On-site professional service at your India venue", "Competitive pricing for individual and bulk orders", "Complete barati packages with matching coordination", "Premium materials - silk, brocade, velvet, and designer fabrics"],
