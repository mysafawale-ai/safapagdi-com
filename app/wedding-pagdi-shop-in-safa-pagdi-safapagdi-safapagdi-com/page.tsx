...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: "https://safapagdi.com/wedding-pagdi-shop-in-safa-pagdi",
    type: "website",
  },
}
...
export default function WeddingPagdiShopInIndiaPage() {
  const pageData = {
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["Expert pagdi specialists with 40+ years experience in India", "Perfect fit with maximum comfort guaranteed all day", "Emergency last-minute service available in India", "Free consultation and design preview via WhatsApp", "On-site professional service at your India venue", "Complete barati packages with matching coordination"],
