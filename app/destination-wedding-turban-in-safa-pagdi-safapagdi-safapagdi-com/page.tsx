...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: "https://safapagdi.com/destination-wedding-turban-in-safa-pagdi",
    type: "website",
  },
}
...
export default function DestinationWeddingTurbanInIndiaPage() {
  const pageData = {
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["Competitive pricing for individual and bulk orders", "On-site professional service at your India venue", "Authentic traditional tying techniques perfected over generations", "Customized designs matching your wedding theme and outfit", "Perfect fit with maximum comfort guaranteed all day", "Complete barati packages with matching coordination"],
