...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: "https://safapagdi.com/barati-safa-tying-for-international-wedding-in-safa-pagdi",
    type: "website",
  },
}
...
export default function BaratiSafaTyingForInternationalWeddingInIndiaPage() {
  const pageData = {
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["Authentic traditional tying techniques perfected over generations", "On-site professional service at your India venue", "Premium materials - silk, brocade, velvet, and designer fabrics", "Expert safa specialists with 40+ years experience in India", "Customized designs matching your wedding theme and outfit", "Complete barati packages with matching coordination"],
