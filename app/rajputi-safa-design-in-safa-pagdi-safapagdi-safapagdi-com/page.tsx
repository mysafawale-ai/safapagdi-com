...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: "https://safapagdi.com/rajputi-safa-design-in-safa-pagdi",
    type: "website",
  },
}
...
export default function RajputiSafaDesignInIndiaPage() {
  const pageData = {
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["Perfect fit with maximum comfort guaranteed all day", "Competitive pricing for individual and bulk orders", "Free consultation and design preview via WhatsApp", "Premium materials - silk, brocade, velvet, and designer fabrics", "Complete barati packages with matching coordination", "Emergency last-minute service available in India"],
