...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: "https://safapagdi.com/groom-pagdi-in-safa-pagdi",
    type: "website",
  },
}
...
export default function GroomPagdiInIndiaPage() {
  const pageData = {
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["Complete barati packages with matching coordination", "Free consultation and design preview via WhatsApp", "On-site professional service at your India venue", "Competitive pricing for individual and bulk orders", "Premium materials - silk, brocade, velvet, and designer fabrics", "Emergency last-minute service available in India"],
