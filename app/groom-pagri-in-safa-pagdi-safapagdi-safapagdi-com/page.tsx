...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: "https://safapagdi.com/groom-pagri-in-safa-pagdi",
    type: "website",
  },
}
...
export default function GroomPagriInIndiaPage() {
  const pageData = {
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["Premium materials - silk, brocade, velvet, and designer fabrics", "Emergency last-minute service available in India", "Competitive pricing for individual and bulk orders", "Complete barati packages with matching coordination", "Expert pagri specialists with 40+ years experience in India", "Authentic traditional tying techniques perfected over generations"],
