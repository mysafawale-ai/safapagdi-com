...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: "https://safapagdi.com/rajwadi-pagdi-in-safa-pagdi",
    type: "website",
  },
}
...
export default function RajwadiPagdiInIndiaPage() {
  const pageData = {
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["Competitive pricing for individual and bulk orders", "Expert pagdi specialists with 40+ years experience in India", "Customized designs matching your wedding theme and outfit", "Authentic traditional tying techniques perfected over generations", "Free consultation and design preview via WhatsApp", "On-site professional service at your India venue"],
