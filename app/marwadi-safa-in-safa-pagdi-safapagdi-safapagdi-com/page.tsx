...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: "https://safapagdi.com/marwadi-safa-in-safa-pagdi",
    type: "website",
  },
}
...
export default function MarwadiSafaInIndiaPage() {
  const pageData = {
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["Free consultation and design preview via WhatsApp", "Complete barati packages with matching coordination", "Emergency last-minute service available in India", "Customized designs matching your wedding theme and outfit", "Expert safa specialists with 40+ years experience in India", "Competitive pricing for individual and bulk orders"],
