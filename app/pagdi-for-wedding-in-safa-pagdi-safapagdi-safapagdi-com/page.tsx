...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: "https://safapagdi.com/pagdi-for-wedding-in-safa-pagdi",
    type: "website",
  },
}
...
export default function PagdiForWeddingInIndiaPage() {
  const pageData = {
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["Expert pagdi specialists with 40+ years experience in India", "Perfect fit with maximum comfort guaranteed all day", "Competitive pricing for individual and bulk orders", "Premium materials - silk, brocade, velvet, and designer fabrics", "Authentic traditional tying techniques perfected over generations", "Emergency last-minute service available in India"],
