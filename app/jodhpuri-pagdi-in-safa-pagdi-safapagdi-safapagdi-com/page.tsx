...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: "https://safapagdi.com/jodhpuri-pagdi-in-safa-pagdi",
    type: "website",
  },
}
...
export default function JodhpuriPagdiInIndiaPage() {
  const pageData = {
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["Complete barati packages with matching coordination", "Premium materials - silk, brocade, velvet, and designer fabrics", "Competitive pricing for individual and bulk orders", "Authentic traditional tying techniques perfected over generations", "Customized designs matching your wedding theme and outfit", "Expert pagdi specialists with 40+ years experience in India"],
