...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: "https://safapagdi.com/traditional-indian-wedding-turban-for-groom-in-safa-pagdi",
    type: "website",
  },
}
...
export default function TraditionalIndianWeddingTurbanForGroomInIndiaPage() {
  const pageData = {
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["Expert turban specialists with 40+ years experience in India", "Emergency last-minute service available in India", "Authentic traditional tying techniques perfected over generations", "Competitive pricing for individual and bulk orders", "Complete barati packages with matching coordination", "Perfect fit with maximum comfort guaranteed all day"],
