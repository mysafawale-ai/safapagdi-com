...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: "https://safapagdi.com/wedding-turban-in-safa-pagdi",
    type: "website",
  },
}
...
export default function WeddingTurbanInIndiaPage() {
  const pageData = {
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["Free consultation and design preview via WhatsApp", "Competitive pricing for individual and bulk orders", "Complete barati packages with matching coordination", "Perfect fit with maximum comfort guaranteed all day", "Emergency last-minute service available in India", "Authentic traditional tying techniques perfected over generations"],
