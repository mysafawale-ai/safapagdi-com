...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: "https://safapagdi.com/wedding-pagdi-for-destination-wedding-in-safa-pagdi",
    type: "website",
  },
}
...
export default function WeddingPagdiForDestinationWeddingInIndiaPage() {
  const pageData = {
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["Emergency last-minute service available in India", "Expert pagdi specialists with 40+ years experience in India", "On-site professional service at your India venue", "Authentic traditional tying techniques perfected over generations", "Competitive pricing for individual and bulk orders", "Free consultation and design preview via WhatsApp"],
