...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: "https://safapagdi.com/barati-safa-on-rent-in-safa-pagdi",
    type: "website",
  },
}
...
export default function BaratiSafaOnRentInIndiaPage() {
  const pageData = {
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["Authentic traditional tying techniques perfected over generations", "Customized designs matching your wedding theme and outfit", "Complete barati packages with matching coordination", "Premium materials - silk, brocade, velvet, and designer fabrics", "Perfect fit with maximum comfort guaranteed all day", "Emergency last-minute service available in India"],
