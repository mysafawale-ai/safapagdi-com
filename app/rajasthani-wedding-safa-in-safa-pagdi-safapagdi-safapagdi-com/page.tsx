...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: "https://safapagdi.com/rajasthani-wedding-safa-in-safa-pagdi",
    type: "website",
  },
}
...
export default function RajasthaniWeddingSafaInIndiaPage() {
  const pageData = {
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["Authentic traditional tying techniques perfected over generations", "Premium materials - silk, brocade, velvet, and designer fabrics", "Customized designs matching your wedding theme and outfit", "Complete barati packages with matching coordination", "Competitive pricing for individual and bulk orders", "On-site professional service at your India venue"],
