...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: "https://safapagdi.com/mens-wedding-turban-in-safa-pagdi",
    type: "website",
  },
}
...
export default function MensWeddingTurbanInIndiaPage() {
  const pageData = {
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["Authentic traditional tying techniques perfected over generations", "On-site professional service at your India venue", "Customized designs matching your wedding theme and outfit", "Emergency last-minute service available in India", "Perfect fit with maximum comfort guaranteed all day", "Expert turban specialists with 40+ years experience in India"],
