...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: "https://safapagdi.com/luxury-wedding-turban-for-groom-in-safa-pagdi",
    type: "website",
  },
}
...
export default function LuxuryWeddingTurbanForGroomInIndiaPage() {
  const pageData = {
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["Premium materials - silk, brocade, velvet, and designer fabrics", "Customized designs matching your wedding theme and outfit", "Expert turban specialists with 40+ years experience in India", "Perfect fit with maximum comfort guaranteed all day", "Free consultation and design preview via WhatsApp", "Competitive pricing for individual and bulk orders"],
